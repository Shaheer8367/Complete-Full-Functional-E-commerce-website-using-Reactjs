...
// Home component
// This component serves as the main page of the application, integrating various components like Banner, Delivery, Brand, Features, Categories, Product, Client, and Recent.
const Home = () => {
...
return (
    <div className="">
        ...
        <div className="w_full min-h-[850px] bg-[#f0f2f3] flex items-center justify-center rounded-b-3xl">
              <Banner></Banner>
        </div>
